...
const COUNTRY_STORAGE_KEY = "VOLTSQ-country";
...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.subtitle":
      "voltsqprovides a secure, transparent, and efficient way to grow your portfolio. Join thousands of investors earning passive income through our advanced trading algorithms.",
    ...
    "about.title": "About voltsqInvest",
    "about.subtitle":
    ...
    "why.heading":
      "Join 15,000+ Traders from across the globe. voltsqis your trusted partner in forex, gold, cannabis, and real estate markets.",
    "why.investmentTitle": "Investment Opportunities",
    "why.investmentText":
      "voltsqleads in diverse investment opportunities, offering investors the chance to explore forex, gold, cannabis, and real estate with tailored funding solutions.",
    ...
    "faq.helpText": "Find answers to frequently asked questions about VOLTSQ.",
  ...
  fr: {
    ...
    "hero.subtitle":
      "voltsqoffre un moyen sûr, transparent et efficace de développer votre portefeuille. Rejoignez des milliers d’investisseurs qui gagnent un revenu passif grâce à nos algorithmes de trading avancés.",
    ...
    "about.title": "À propos de voltsqInvest",
    "about.subtitle":
    ...
    "why.heading":
      "Rejoignez plus de 15 000 traders dans le monde. voltsqest votre partenaire de confiance pour le forex, l’or, le cannabis et l’immobilier.",
    "why.investmentTitle": "Opportunités d’investissement",
    "why.investmentText":
      "voltsqpropose des opportunités diversifiées avec des solutions de financement adaptées et des modèles de partage de profit compétitifs.",
    ...
    "faq.helpText": "Trouvez des réponses aux questions fréquentes sur VOLTSQ.",
  ...
  es: {
    ...
    "hero.subtitle":
      "voltsqofrece una forma segura, transparente y eficiente de hacer crecer tu portafolio. Únete a miles de inversores que ganan ingresos pasivos con nuestros algoritmos avanzados de trading.",
    ...
    "about.title": "Acerca de voltsqInvest",
    "about.subtitle":
    ...
    "why.heading":
      "Únete a más de 15 000 traders en todo el mundo. voltsqes tu socio de confianza en forex, oro, cannabis e inmobiliario.",
    "why.investmentTitle": "Oportunidades de inversión",
    "why.investmentText":
      "voltsqlidera en oportunidades diversas con soluciones de financiación a medida y modelos competitivos de reparto de beneficios.",
    ...
    "faq.helpText": "Encuentra respuestas a preguntas frecuentes sobre VOLTSQ.",
  ...
  pt: {
    ...
    "hero.subtitle":
      "A voltsqoferece uma forma segura, transparente e eficiente de aumentar o seu portfólio. Junte-se a milhares de investidores que recebem renda passiva com nossos algoritmos avançados de negociação.",
    "hero.primaryCta": "Começar a investir",
    "hero.secondaryCta": "Ver mercados",
    "hero.stat.assets": "Ativos sob gestão",
    "hero.stat.investors": "Investidores ativos",
    "hero.stat.countries": "Países",
    "about.title": "Sobre a voltsqInvest",
    "about.subtitle":
    ...
    "why.heading":
      "Junte-se a mais de 15.000 traders em todo o mundo. A voltsqé o seu parceiro de confiança em forex, ouro, cannabis e imobiliário.",
    "why.investmentTitle": "Oportunidades de investimento",
    "why.investmentText":
      "A voltsqlidera em oportunidades diversificadas com soluções de financiamento personalizadas e modelos competitivos de partilha de lucros.",
    ...
    "faq.helpText":
      "Encontre respostas para perguntas frequentes sobre a VOLTSQ.",
  ...
  de: {
    ...
    "hero.subtitle":
      "voltsqbietet eine sichere, transparente und effiziente Möglichkeit, Ihr Portfolio zu vergrößern. Schließen Sie sich tausenden Anlegern an, die mit unseren fortschrittlichen Handelsalgorithmen passives Einkommen erzielen.",
    ...
    "why.heading":
      "Schließen Sie sich über 15.000 Tradern weltweit an. voltsqist Ihr vertrauenswürdiger Partner für Forex, Gold, Cannabis und Immobilien.",
    "why.investmentTitle": "Investitionsmöglichkeiten",
    "why.investmentText":
      "voltsqbietet vielfältige Investitionsmöglichkeiten in Forex, Gold, Cannabis und Immobilien mit maßgeschneiderten Finanzierungslösungen.",
    ...
    "faq.helpText": "Finden Sie Antworten auf häufige Fragen zu VOLTSQ.",
