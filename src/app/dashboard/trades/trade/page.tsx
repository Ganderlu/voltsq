      ...
      >
        <Box>
          ...
          <Typography variant="body2" sx={{ color: "var(--muted-foreground)" }}>
            Execute trades on global markets with instant execution and
        ...
        >
          <Box sx={{ textAlign: isMobile ? "left" : "right" }}>
            ...
            <Typography
              variant="body2"
              fontWeight="800"
              sx={{ color: stats.mode === "live" ? "#22c55e" : "#eab308" }}
            >
      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        ...
        <Grid size={{ xs: 6, md: 3 }}>
          <StatCard
            ...
            color={stats.netPnL >= 0 ? "#22c55e" : "#ef4444"}
            isProfit
          />
        </Grid>
      </Grid>
