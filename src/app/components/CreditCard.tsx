      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-xl mb-8">
            ...
            the World Bank. Through our Card, voltsqinvestors can have a virtual
            card issued to them while a physical card is mailed to them. The
            card has a minimum of $2,000 balance needed. It can be used at over
            45 million merchants and ATMs – anywhere in the world where major
