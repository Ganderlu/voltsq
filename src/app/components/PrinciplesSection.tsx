...
export default function PrinciplesSection() {
  return (
    <section className="w-full bg-gradient-to-b from-black to-neutral-900 py-24 px-4">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <span className="inline-block text-xs md:text-sm text-emerald-400 border border-emerald-500/40 rounded-full px-4 py-2 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          {/* Mission */}
          <div className="bg-black rounded-2xl p-8 md:p-10 shadow-lg border border-white/5">
            <Target className="text-white mb-6" size={28} />
          ...
          {/* Vision */}
          <div className="bg-black rounded-2xl p-8 md:p-10 shadow-lg border border-white/5">
            <Eye className="text-white mb-6" size={28} />
